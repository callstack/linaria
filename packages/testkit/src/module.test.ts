...
it('imports JS files', () => {
  ...
  expect((mod.exports as any).result).toBe('The answer is 42');
});
...
it('imports TypeScript files', () => {
  ...
  expect((mod.exports as any).result).toBe('The answer is 27');
});
...
it('imports JSON files', () => {
  ...
  expect((mod.exports as any).default).toBe('Our saviour, Luke Skywalker');
});
